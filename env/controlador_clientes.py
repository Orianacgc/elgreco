...
def insertar_cliente(num_cliente,aPaterno,aMaterno,nombre,telefono,email,calle,numero_exterior,numero_interior,colonia,CP,RFC,regimen):
...
def actualizar_cliente(idcliente,num_cliente,aPaterno,aMaterno,nombres,telefono,email,calle,numero_exterior,numero_interior,colonia,CP,RFC,regimen):
    conexion = obtener_conexion()
    with conexion.cursor() as cursor:
